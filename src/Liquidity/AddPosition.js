...
function AddPosition() {
  ...
  const data = [
    ...
    },
    {
      ...
      date: "2023/07/28",
      describe: "KC Coin",
      rate: 1000000000000000 / 4098013272909541346,
      amount: 0,
    ...
    },
    {
      ...
      rate: 0.000099999999999999 / 499999.999999999954545799,
      amount: 0,
    ...
    },
    {
      ...
      rate: 0.000000999999999999 / 123415.992015478839998016,
      amount: 0,
  ...
  async function Apply() {
    ...
    console.log("uint256", web3.utils.toWei(left_inp, "ether"));
    console.log(AmountB);
    console.log(web3.eth.abi.encodeParameter("uint256", AmountB.toString()));
    await contract_used.methods
      ...
      .then(() => alert("Transition complete!"))
      .catch((err) => {
        console.log(err);
